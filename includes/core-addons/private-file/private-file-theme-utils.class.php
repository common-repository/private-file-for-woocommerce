...
if (!class_exists('PFFW_PrivateFileThemeUtils')) :
 ...
 * 
 */
class PFFW_PrivateFileThemeUtils {
	...
	public static function get_the_file_link( $post_id = null, $action = 'download' ) {
		...
		return $pffw_pf_addon->get_file_permalink( $post_id, $action );
	}
	...
	public static function get_the_file_name( $post_id = null ) {
		...
		return apply_filters( 'pffw_the_file_name', $file['file'] );
	}
	...
	public static function get_the_file_type( $post_id = null ) {
		...
		return apply_filters( 'pffw_the_file_type', pathinfo( $file['file'], PATHINFO_EXTENSION ) );
	}
...
endif; // if (!class_exists('PFFW_PrivateFileThemeUtils')) :